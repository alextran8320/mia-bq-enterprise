...
**Approved By**: A01 PM Agent — Promoted to SRS Ready 2026-04-16; action taxonomy specifics deferred to BE/integration phase per BQ pilot scope decision
...
| Câu hỏi | Quyết định |
|---------|-----------|
| Action types phase 1 | **4 loại:** Hỏi thêm thông tin khách (size/màu/ngân sách) · Offer khuyến mãi đang chạy · Đề xuất chốt đơn/đặt cọc · Chuyển lên TL hoặc chuyên gia |
| Action ranking | Rule-based trong phase 1; không có score |
| KPI đo ở level nào? | Defer — chưa cần chốt cho FE Preview |

**Impact lên UXUI / FE:**
- 4 suggestion card types với icon và label tương ứng
- Order hiển thị theo priority rule tĩnh (không dynamic ranking)
- Max 3 suggestion cards; luôn có rationale 1 dòng
