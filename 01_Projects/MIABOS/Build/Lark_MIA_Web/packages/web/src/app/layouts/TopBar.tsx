...
import { Bell, ChevronDown, ChevronRight, KeyRound, Link2, ListTodo, LogOut, Plug, ScrollText, Search, Settings, Shield, Store, User, Users } from "lucide-react";
...
function UserMenu() {
  ...
  const display = user?.fullName || user?.email || "Tài khoản";
  const seed = encodeURIComponent(user?.email ?? "anon");
    ...
    <div ref={ref} style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          borderRadius: 999,
          background: "transparent",
          border: open ? "2px solid rgba(47,100,246,0.4)" : "2px solid transparent",
          cursor: "pointer",
      ...
      {open && user && (
        ...
        >
          ...
          <button onClick={onLogout} style={{ ...menuBtnStyle, color: "var(--color-danger, #B91C1C)" }}>
