...
| UX Patterns & IA | [RES-M08-KNW_UX_Patterns_And_IA.md](../../Research/Knowledge_Center/RES-M08-KNW_UX_Patterns_And_IA.md) | Source Citation; Quick Reply Chips; Step-by-Step SOP; Role-Aware Header; Uncertainty; Feedback; Human Escalation |
...
|---------|--------------|--------|
| Source Citation Block | Document detail view | ✅ |
| Quick Reply Chips (related topics sau search) | Search result + document detail | ✅ |
...
| Right Sidebar TOC (article dài) | Document detail view | ✅ |
| Role-Aware Header | Document detail view | ✅ |
| Feedback Loop (thumbs up/down) | Document detail view + no-result | ✅ |
...
│ Gợi ý tiếp theo: [SOP đổi trả] [Ngoại lệ] [Hỏi người thật]  │
├─────────────────────────────────────────────────────────────┤
...
│ Câu hỏi tiếp theo: [Ngoại lệ] [SOP] [Hỏi người thật]        │
...
│ • Xem FAQ theo chủ đề                                      │
│ Em đã search trong Knowledge Base nội bộ, không phải internet│
│                                                             │
│ [Hỏi người thật] [Gửi phản hồi]                            │
└─────────────────────────────────────────────────────────────┘
```
...
| Results | Response | `document_type`, `title`, `owner_department`, `effective_date`, `freshness_status`, `quick_reply_suggestions` | Array |
| Document detail | `GET /mia/knowledge/documents/:id` | `detail`, `metadata`, `source_citation`, `role_scope`, `related_docs`, `quick_reply_suggestions`, `feedback_action`, `access_flags`, `version_reference`, `assets[]` | Object |
...
- [ ] Search/detail có quick reply chips/related topics
- [ ] Filter by type và department
- [ ] Document detail: rule chính ở đầu, progressive disclosure
- [ ] Document detail có source citation block, role-aware header, right sidebar TOC cho article dài, feedback thumbs up/down
