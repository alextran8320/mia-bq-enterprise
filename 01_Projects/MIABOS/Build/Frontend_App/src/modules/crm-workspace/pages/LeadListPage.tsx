...
const leads = CUSTOMERS.filter((c) => c.status === "Lead" || c.status === "Qualified");
...
const columns: Column<Customer>[] = [
    ...
    render: (c) => (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
        ...
        <div>
          ...
          <div style={{ fontSize: "11px", color: "var(--color-text-tertiary)" }}>{c.source}</div>
        </div>
      </div>
    ),
  },
  ...
  { key: "consent", header: "Consent", render: (c) => (c.consentGiven ? "OK" : "Chưa") },
...
export function LeadListPage() {
  ...
  return (
    <div>
      ...
      <h1 style={{ marginBottom: "var(--space-6)" }}>Leads</h1>
